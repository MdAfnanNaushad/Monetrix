                ...
                <div className="col-md-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div>
                                <Progress type='circle' strokeColor={'green'} className='mx-2' percent={totalExpensePercent.toFixed(0)} />
                                <Progress type='circle' strokeColor={'red'} className='mx-2' percent={totalIncomePercent.toFixed(0)} />
                            </div>
                        </div>
                    </div>
                </div>
